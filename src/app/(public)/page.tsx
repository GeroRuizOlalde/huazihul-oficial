...
export default async function HomePage() {
  ...
  // Traemos Noticias, Partidos y ahora también los Productos de la Tienda
  const [
    { data: noticiasBD, error: noticiasError },
    { data: proximo, error: proximoError },
    { data: ultimo, error: ultimoError },
    { data: productosBD, error: productosError },
  ] = await Promise.all([
    supabase
      .from("noticias")
    ...
    <div className="flex min-h-screen flex-col bg-white font-sans text-zinc-900 selection:bg-red-600 selection:text-white">
        ...
        <div className="relative z-20 border-b-4 border-red-600 bg-zinc-950 py-6 shadow-2xl lg:py-4">
          <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center justify-between gap-6 px-4 md:px-8 lg:flex-row lg:gap-4">
            <div className="flex flex-col items-center gap-3 text-white sm:flex-row md:gap-4">
              <Badge className={`${yaPaso ? "bg-zinc-700" : "animate-pulse bg-red-600"} border-none rounded-none px-3 py-1.5 text-[10px] tracking-widest text-white`}>
            ...
            <div className="flex items-center gap-4 md:gap-10">
              <span className={`text-xl font-black uppercase tracking-tighter md:text-3xl ${huazihulEsLocal ? "text-white" : "text-zinc-600"}`}>
                {partidoBD.equipo_local ?? "Local"}
              </span>
              <div className="flex items-center gap-2 rounded-lg border border-white/10 bg-white/5 px-4 py-2">
                <span className={`text-2xl font-black md:text-4xl ${huazihulEsLocal ? "text-red-600" : "text-white"}`}>
                  {partidoBD.resultado_local ?? (yaPaso ? "0" : "-")}
                </span>
                <span className="px-2 text-xl font-black italic text-zinc-700">VS</span>
                <span className={`text-2xl font-black md:text-4xl ${!huazihulEsLocal ? "text-red-600" : "text-white"}`}>
            ...
            <div className="flex flex-col items-center gap-4 sm:flex-row">
              ...
              <Link href="/fixture" className="flex items-center border-b border-white/20 pb-1 text-[10px] font-black uppercase tracking-widest text-white transition-colors hover:text-red-500">
        ...
        <div className="mx-auto w-full max-w-[1440px] px-6 md:px-8">
          <div className="mb-12 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <h2 className="text-4xl font-black uppercase tracking-tighter text-zinc-900 md:text-5xl">Disciplinas</h2>
            </div>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-10">
            <Link href="/deportes/rugby" className="group relative block h-[400px] overflow-hidden bg-zinc-100 md:h-[600px]">
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGENES.rugby})` }} />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-80" />
              <div className="absolute bottom-0 left-0 w-full p-6 md:p-12">
                <h3 className="mb-4 text-3xl font-black uppercase tracking-tighter text-white md:text-5xl">Rugby</h3>
            ...
            <Link href="/deportes/hockey" className="group relative block h-[400px] overflow-hidden bg-zinc-100 md:h-[600px]">
              <div className="absolute inset-0 bg-cover bg-center transition-transform duration-700 group-hover:scale-105" style={{ backgroundImage: `url(${IMAGENES.hockey})` }} />
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-80" />
              <div className="absolute bottom-0 left-0 w-full p-6 md:p-12">
                <h3 className="mb-4 text-3xl font-black uppercase tracking-tighter text-white md:text-5xl">Hockey</h3>
                <div className="inline-flex items-center text-xs font-bold uppercase tracking-widest text-red-500 transition-colors group-hover:text-white">
                  Ver Entrenamientos <ArrowRight className="ml-2 h-4 w-4" />
                </div>
              </div>
            </Link>
          </div>
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1440px] px-6 md:px-8">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <div className="order-2 lg:order-1">
              <div className="mb-4 h-1.5 w-12 bg-red-600" />
              <h2 className="mb-6 text-4xl font-black uppercase tracking-tighter text-white md:text-5xl">La Vida <br /> en el Club</h2>
              ...
              <div className="mb-10 grid grid-cols-2 gap-4">
                <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white md:text-xs">
                  <Heart className="h-5 w-5 text-red-600" /> Amistad
                </div>
                <div className="flex items-center gap-3 text-[10px] font-bold uppercase tracking-widest text-white md:text-xs">
                  <Users className="h-5 w-5 text-red-600" /> Familia
                </div>
              </div>
              <Button variant="outline" asChild className="h-12 w-full rounded-none border-red-600 bg-transparent px-8 font-bold uppercase tracking-widest text-red-500 hover:bg-red-600 hover:text-white sm:w-auto">
                <Link href="/el-club">Instalaciones</Link>
              </Button>
            </div>
            <div className="relative order-1 h-[300px] w-full lg:order-2 lg:h-[600px] md:h-[500px]">
              <div className="absolute inset-0 z-10 mb-4 ml-4 border-b-4 border-l-4 border-red-600 bg-cover bg-center shadow-2xl md:mb-8 md:ml-8 md:border-b-8 md:border-l-8" style={{ backgroundImage: `url(${IMAGENES.clubVida})` }} />
      ...
      <section className="bg-zinc-50 py-16 md:py-24">
        <div className="mx-auto w-full max-w-[1440px] px-6 md:px-8">
          <div className="mb-12 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            <div>
              <div className="mb-4 h-1.5 w-12 bg-red-600" />
              <h2 className="text-4xl font-black uppercase tracking-tighter text-zinc-900 md:text-5xl">Actualidad</h2>
            </div>
            <Link href="/noticias" className="flex items-center text-xs font-bold uppercase tracking-widest text-red-600">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
              {noticias.map((news) => (
                <Link href={`/noticias/${news.id}`} key={news.id} className="group flex h-full flex-col border-b-4 border-transparent bg-white p-4 shadow-sm transition-shadow hover:border-red-600 hover:shadow-xl">
                  ...
                  <h3 className="mb-3 text-xl font-black uppercase tracking-tight text-zinc-900 group-hover:text-red-600">{news.titulo}</h3>
                  <p className="mb-5 line-clamp-2 text-xs font-light text-zinc-600">{news.descripcion}</p>
                  <span className="mt-auto flex items-center text-[10px] font-bold uppercase tracking-widest text-zinc-900 transition-transform group-hover:translate-x-2">
                    Leer más <ArrowRight className="ml-2 h-4 w-4 text-red-600" />
                  </span>
                </Link>
              ))}
            </div>
          ) : (
            <div className="border-2 border-dashed border-zinc-200 py-20 text-center text-sm font-black uppercase tracking-widest text-zinc-300">Próximamente novedades.</div>
          )}
        </div>
      </section>

      {/* BOUTIQUE OFICIAL (INTEGRADA) */}
          ...
          <div className="mb-12 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-red-600 font-black uppercase tracking-[0.3em] text-[10px]">Nueva Colección</span>
              </div>
              <h2 className="text-4xl font-black uppercase tracking-tighter text-zinc-900 md:text-5xl italic">Boutique Oficial</h2>
            </div>
            <Link href="/tienda" className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-zinc-900 hover:text-red-600 transition-colors">
      ...
      <section className="flex flex-col bg-zinc-900 lg:flex-row">
        <div className="relative flex min-h-[400px] flex-col justify-center overflow-hidden border-b-8 border-amber-600 bg-black p-8 md:p-16 lg:w-1/2 lg:border-r-8 lg:border-b-0 lg:p-20">
          ...
          <div className="relative z-10">
            <h2 className="mb-4 text-3xl font-black uppercase tracking-tighter text-white md:text-5xl">Camino al <span className="text-amber-500">Centenario</span></h2>
            <div className="origin-left my-8 scale-90 sm:scale-100">
              <Countdown />
            </div>
            <Button asChild className="h-14 w-full rounded-none bg-amber-600 px-8 font-bold uppercase tracking-widest text-white hover:bg-amber-700 sm:w-auto">
        ...
        <div className="flex min-h-[400px] flex-col justify-center bg-zinc-900 p-8 text-center lg:w-1/2 lg:p-20 lg:text-left md:p-16">
          <h2 className="mb-6 text-3xl font-black uppercase tracking-tighter text-white md:text-5xl">Portal <br /> <span className="text-red-600">Autogestión</span></h2>
          <p className="mx-auto mb-8 max-w-sm font-light italic text-zinc-500 lg:mx-0">Acceso exclusivo para administradores del club.</p>
          <Button variant="outline" asChild className="h-14 w-full rounded-none border-white bg-transparent px-8 font-bold uppercase tracking-widest text-white transition-all hover:bg-white hover:text-black sm:w-auto">
      ...
      <section className="border-t border-zinc-100 bg-white py-20">
        <div className="mx-auto w-full max-w-[1440px] px-4 text-center">
          <h4 className="mb-12 text-[10px] font-bold uppercase tracking-widest text-zinc-400">Sponsors Oficiales que apoyan el club</h4>
          <div className="flex flex-wrap items-center justify-center gap-10 opacity-30 grayscale transition-all duration-700 hover:opacity-100 hover:grayscale-0 md:gap-20">
            {sponsorsOficiales.map((sponsor) => (
              <span key={sponsor.id} className="text-xl font-black uppercase italic tracking-tighter text-zinc-900 md:text-3xl">
                {sponsor.nombre}
              </span>
            ))}
          </div>
